        ...
        return (
          ...
          >
            ...
            <section className="flex justify-between">
              <p className="text-sm md:text-lg">Created At</p>
              <time className="text-sm md:text-lg">{new Date(entry.created_at.toString()).toLocaleDateString()}</time>
            </section>
            <section className="flex justify-between">
              <p className="text-sm md:text-lg">Scheduled For</p>
              <time className="text-sm md:text-lg">{new Date(entry.scheduled.toString()).toLocaleDateString()}</time>
            </section>
