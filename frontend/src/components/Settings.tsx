    ...
    <div className="flex items-center justify-center fixed top-0 h-screen w-screen bg-black bg-opacity-60">
      <div className="flex flex-col gap-5 p-5 rounded-md bg-gray-300 dark:bg-gray-700">
        ...
        <label className="inline-flex gap-3 items-center cursor-pointer">
          <input onChange={updateDarkMode} type="checkbox" value="" defaultChecked={document.documentElement.classList.contains('dark')} className="sr-only peer"></input>
        ...
        <button onClick={closeSettings} className="m-3 px-4 py-2 bg-blue-400 dark:bg-blue-700 hover:bg-blue-500 dark:hover:bg-blue-800 rounded-md text-white">Close</button>
      </div>
    </div>
  )
}
